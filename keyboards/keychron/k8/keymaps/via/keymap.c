...
*/
  ...
  [WIN_FN] = LAYOUT_tkl_ansi(
          RESET,          KC_BRID, KC_BRIU, KC_TASK, KC_FLXP, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD,   KC_VOLU,     _______,  _______,  RGB_TOG,
        ...
        _______, _______, _______,                   MAGIC_TOGGLE_NKRO,                           _______, _______, _______,   _______,     RGB_RMOD,  RGB_VAD,  RGB_MOD
    ),
  ...
  [MAC_FN] = LAYOUT_tkl_ansi( // Mac Fn overlay
      RESET,            KC_BRID, KC_BRIU, KC_MSSN, KC_FIND, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU,         KC_MSNP, KC_SIRI, RGB_TOG,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,         RGB_SPI, RGB_SAI, RGB_HUI,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,         RGB_SPD, RGB_SAD, RGB_HUD,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,                             RGB_VAI,
